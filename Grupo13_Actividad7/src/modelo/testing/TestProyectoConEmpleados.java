...
public class TestProyectoConEmpleados {
	...
	public static void main(String[] args) {
		...
		con.setNumeroOrden(5);
		con.setProyecto(proye.buscarUno("FOR2020001"));
		con.setEmpleados(employee.buscarUno(100));
		con.setHorasAsignadas(74);
		con.setFechaIncorporacion(incorporacion);
		...
		for (ProyectoConEmpleados ele: pced.horasAsignadasAProyecto("FOR2021001"))
			System.out.println(ele);
		System.out.println(" ");
		
		//Averiguamos el coste de un proyecto
		System.out.println("Queremos saber el coste del proyecto FOR2020001");
		for (ProyectoConEmpleados ele: pced.costeActualDeProyecto("FOR2020001"))
			System.out.println(ele);
		System.out.println(" ");
		...
		for (ProyectoConEmpleados ele: pced.margenActualProyecto("FOR2020001"))
			System.out.println(ele);
